...
public class ImageTool extends JFrame {
	...
	*/
    ...
    public int[][][] imageFileToPixels (String fileName) throws IOException
    {
    ...
    public int[][] imageFileToGreyPixels (String fileName) throws IOException
    {
        Image image = readImageFile (fileName);
        int[][][] pixels = imageToPixels (image);
        return pixelsToGreyPixels (pixels);
	...
	Image image = imTool.readImageFile ("ace.jpg");
